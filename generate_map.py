...
# display = {state: "displayName('"+state+"')" for state in all_states}
# s = 'New Hampshire' in words_dict.keys()

print str(len(words_dict)) +' '+ str(len(all_states))
print words_dict['Illinois']
